...
from .models import (Chart, ZodiacInColors,
                     FullChart, TransitFullChart,OneColorZodiacRingMF)
...
class TransitForm(forms.Form):
    ...
    event_country = forms.CharField(label='Enter event country',
                                    initial='Russia')
    ev_mode = forms.ChoiceField(label='Chose event chart mode',
    ...
    transit_country = forms.CharField(label='Enter transit country',
                                      initial='Russia')
    tr_mode = forms.ChoiceField(label='Chose transit chart mode',
                                choices=MODE_CHOICES, initial='Sidereal',
                                widget=forms.Select)
...
class FullChartForm(forms.ModelForm):
    class Meta:
        model = FullChart
        fields = ['chart_name','chart_date', 'city',
                  'country', 'chart_mode', 'house_system']
...
class OneColorZodiacRing(forms.Form):
    ...
    oc_chart_date = (forms.DateTimeField
                     ...
                     (attrs={'class': 'form-control','id': 'chart-date'}),
    ...
    face_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                      'id': 'face-color'}),
                            label='Enter face color',
                            initial='#300c63')
    edge_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                      'id': 'edge-color'}),
                            label='Enter edge color', initial='#3dffc8')
    text_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                      'id': 'text-color'}),
                            label='Enter zodiac symbol color',
                            initial='#3dffc8')
    tick_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                      'id': 'tick-color'}),
                            label='Enter tick color', initial='#63ffd3')
    deg_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                     'id': 'deg-color'}),
                           label='Enter degree tick color', initial='#63ffd3')
    marker_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                        'id': 'marker-color'}),
                              label='Enter planet symbol marker color',
                              initial='#ffc83d')
    symbol_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                        'id': 'symbol-color'}),
                              label='Enter planet symbol color',
                              initial='#ff3d74')

    house_ax_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                          'id': 'ha-color'}),
                                label='Enter house ax color',
                                initial='#ffc83d')
    house_number_color = (ColorField
                          (widget=ColorWidget(attrs={'class': 'form-control',
                                                    'id': 'hnum-color'}),
                                    label='Enter house number color',
                                    initial='#ffc83d'))
    house_track_color = ColorField(widget=ColorWidget(attrs={'class': 'form-control',
                                                             'id': 'htr-color'}),
