...
track_aries.axis(fc="#331386", ec="aliceblue", lw=3)
...
for sector in circos.sectors:
    ...
    track_deg.axis(ec='aliceblue', lw=1.5)
    track_deg.grid(y_grid_num=None, x_grid_interval=1, color='aliceblue')

fig = circos.plotfig()
fig.patch.set_alpha(0.0)
fig.savefig('drawings/zr_final_dp_pp.png', pad_inches=0.0)